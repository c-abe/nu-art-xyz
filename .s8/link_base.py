...
BASE = {
    ...
    "Rely": ("139307815", "Rely", 10000, "small world"),
    "Imitation girl": ("139307786", "Imitation girl", 10000, "small world"),
    "Beautiful memory": ("139307750", "Beautiful memory", 10000, "small world"),
    "ROOM 202": ("139307715", "ROOM 202", 10000, "small world"),
    "SOS": ("139304480", "SOS", 10000, "small world"),
    "women05_B2": ("139307412", "Compass", 10000, "Beautiful Women"),
    "women04_B2": ("139307299", "Earrings", 10000, "Beautiful Women"),
    "women03_B2": ("139306964", "Thread", 10000, "Beautiful Women"),
    "women02_B2": ("139299191", "GREENEYES", 10000, "Beautiful Women"),
    "women01_B1": ("139298895", "Seeds", 10000, "Beautiful Women"),
}
